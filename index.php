...
if (idx != '') {
  var message = '';
  if (isWinner) {
     message = "Congratulations! You won our lottery. Please type in and then submit your email address in the field below, and we will send you a $20 gift certificate to Amazon.com.<p>Thank you for participating in our experiment!";
  } else {
